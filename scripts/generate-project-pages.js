...
const projects = [
  {
    ...
    metaDesc:
      "Descubre nuestro proyecto de paisajismo seco y reconversión hídrica en Quilicura, Chile. Expertos en mantención de áreas verdes y eficiencia hídrica.",
    keywords:
      "paisajismo seco, reconversion hidrica chile, mantencion areas verdes quilicura, riego automatizado, expertos paisajismo chile",
  ...
  },
  {
    ...
    metaDesc:
      "Diseño e implementación de terraza corporativa en Las Condes. Expertos en paisajismo corporativo, macetas y árboles ornamentales en Chile.",
    keywords:
      "terraza corporativa, paisajismo corporativo las condes, mantencion areas verdes santiago, arboles ornamentales chile",
    mandante: "Edificio Corporativo Bash",
    superficie: "450 m²",
    plazo: "15 días",
    servicio: "Diseño e implementación macetas y arboles",
    seoText:
      "Transformamos este espacio en Las Condes mediante el <strong>diseño y paisajismo corporativo</strong>. Proveímos e instalamos macetas y árboles ornamentales seleccionados especialmente para soportar las condiciones urbanas. Este proyecto de <strong>mantención de áreas verdes y paisajismo en Chile</strong> mejora el entorno laboral, aportando valor estético y bienestar a los colaboradores del Edificio Corporativo Bash.",
  },
  {
  ...
  },
  {
    ...
    metaDesc:
      "Contrato de mantención de áreas verdes industriales y poda en altura en San Ignacio. Empresa líder en paisajismo en Chile.",
    keywords:
      "mantencion areas verdes industriales, poda en altura chile, paisajismo industrial, jardineria san ignacio",
    mandante: "Arauco San Ignacio",
  ...
  },
  {
    ...
    metaDesc:
      "Ingeniería e instalación de muro verde vertical en zonas de alto tránsito en Vitacura. Expertos en paisajismo corporativo e innovación.",
    keywords:
      "muro verde vertical, paisajismo corporativo vitacura, diseño areas verdes chile, jardines verticales santiago",
  ...
  },
  {
    ...
    metaDesc:
      "Servicio de fumigación y control fitosanitario para grandes superficies industriales en Quilicura. Expertos en salud vegetal en Chile.",
    keywords:
      "fumigacion areas verdes, control fitosanitario chile, prevencion de plagas, mantencion areas verdes quilicura",
    mandante: "Arauco Quilicura",
    superficie: "8.500 m²",
  ...
  },
  {
    ...
    metaDesc:
      "Modelado 3D y diseño de paisajismo para habilitación de piscinas en Chicureo. Transforma tus áreas verdes con expertos en Chile.",
    keywords:
      "diseño paisajismo piscina, habilitacion entorno chicureo, diseño areas verdes chile, modelado 3d jardines",
    mandante: "Condominio Los Olivos",
    superficie: "700 m²",
    plazo: "15 días",
    servicio: "Modelado 3D y paisajismo",
    seoText:
      "En Chicureo, realizamos el <strong>diseño de paisajismo</strong> y modelado 3D para la habilitación integral del entorno de una piscina. Como líderes en <strong>diseño de áreas verdes en Chile</strong>, proyectamos espacios que integran armoniosamente el agua, la vegetación y la arquitectura, entregando una visualización hiperrealista antes de la ejecución de la obra.",
  },
  {
    ...
    metaDesc:
      "Proyecto de paisajismo residencial en Zapallar. Especialistas en instalación de pasto alfombra, riego automatizado y mantención de áreas verdes.",
    keywords:
      "paisajismo residencial zapallar, instalacion pasto alfombra, sistema de riego chile, mantencion areas verdes",
