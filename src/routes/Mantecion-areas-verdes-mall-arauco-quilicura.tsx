        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">
              Mantención de Áreas Verdes Mall Arauco Quilicura
            </h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Servicio de <strong>Mantención Corporativa</strong> correspondiente al cuidado
                integral de las áreas verdes del Mall Arauco Quilicura. A través de un contrato
                anual, nos encargamos de preservar la vitalidad y estética del paisajismo en estas
                instalaciones, garantizando un entorno agradable y ecológicamente sostenible para
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <div className="mt-10 pt-8 border-t border-border/50 text-center">
                <p className="text-sm text-muted-foreground mb-4">
                  ¿Necesitas mantención corporativa?
                </p>
                <a
                  href="/#contacto"
