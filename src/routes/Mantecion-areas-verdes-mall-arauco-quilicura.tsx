...
import img1 from "@/assets/Mantenciones/Mantecion-areas-verdes-mall-arauco-quilicura-1.jpg";
import img2 from "@/assets/Mantenciones/Mantecion-areas-verdes-mall-arauco-quilicura-2.jpg";
import img3 from "@/assets/Mantenciones/Mantecion-areas-verdes-mall-arauco-quilicura-3.jpg";
import img4 from "@/assets/Mantenciones/Mantecion-areas-verdes-mall-arauco-quilicura-4.jpg";

export const Route = createFileRoute("/Mantecion-areas-verdes-mall-arauco-quilicura")({
  head: () => ({
    meta: [
      { title: "Mantención Áreas Verdes Mall Arauco Quilicura | Bascharant" },
      { name: "description", content: "Mantecion-areas-verdes-mall-arauco-quilicura." },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">Mantención de Áreas Verdes Mall Arauco Quilicura</h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Mantención Áreas Verdes Mall Arauco Quilicura - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Servicio de <strong>Mantención Corporativa</strong> correspondiente al cuidado integral de las áreas verdes del Mall Arauco Quilicura. A través de un contrato anual, nos encargamos de preservar la vitalidad y estética del paisajismo en estas instalaciones, garantizando un entorno agradable y ecológicamente sostenible para todos los visitantes.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <div className="mt-10 pt-8 border-t border-border/50 text-center">
                <p className="text-sm text-muted-foreground mb-4">¿Necesitas mantención corporativa?</p>
                <a 
                  href="/#contacto"
