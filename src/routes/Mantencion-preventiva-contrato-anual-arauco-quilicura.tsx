...
import img1 from "@/assets/Mantenciones/Mantecion-preventiva-contrato-anual-arauco-quilicura-1.jpg";
import img2 from "@/assets/Mantenciones/Mantecion-preventiva-contrato-anual-arauco-quilicura-2.jpg";
import img3 from "@/assets/Mantenciones/Mantecion-preventiva-contrato-anual-arauco-quilicura-3.jpg";
import img4 from "@/assets/Mantenciones/Mantecion-preventiva-contrato-anual-arauco-quilicura-4.jpg";

export const Route = createFileRoute("/Mantencion-preventiva-contrato-anual-arauco-quilicura")({
  head: () => ({
    meta: [
      { title: "Mantención Preventiva Contrato Anual Arauco Quilicura | Bascharant" },
      { name: "description", content: "Servicio de mantención preventiva bajo contrato anual en Arauco Quilicura." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Mantención Preventiva Contrato Anual Arauco Quilicura</h1>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Mantención Preventiva - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Desarrollo del programa de <strong>mantención preventiva</strong> bajo contrato anual en las instalaciones de Arauco Quilicura. Este servicio continuo garantiza la óptima conservación de las áreas verdes y ecosistemas del lugar, abarcando tareas recurrentes de cuidado, monitoreo de especies, y ajustes técnicos durante todas las estaciones del año para mantener el estándar paisajístico requerido por el mandante.
              </p>
            </div>
          </div>
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-primary">Contrato Anual</span>
                  </span>
                </li>
              </ul>
