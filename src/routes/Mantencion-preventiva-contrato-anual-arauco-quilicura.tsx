...
export const Route = createFileRoute("/Mantencion-preventiva-contrato-anual-arauco-quilicura")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Servicio de mantención preventiva bajo contrato anual en Arauco Quilicura.",
      },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            Mantención Preventiva Contrato Anual Arauco Quilicura
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Desarrollo del programa de <strong>mantención preventiva</strong> bajo contrato
                anual en las instalaciones de Arauco Quilicura. Este servicio continuo garantiza la
                óptima conservación de las áreas verdes y ecosistemas del lugar, abarcando tareas
                recurrentes de cuidado, monitoreo de especies, y ajustes técnicos durante todas las
                estaciones del año para mantener el estándar paisajístico requerido por el mandante.
              </p>
            </div>
          </div>
