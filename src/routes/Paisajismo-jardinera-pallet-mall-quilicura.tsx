...
import img1 from "@/assets/Paisajismo/Pallet-jardinera-quilicura-reciclaje.jpg";
import img2 from "@/assets/Paisajismo/Pallet-jardinera-quilicura-reciclaje-2.jpg";
import img3 from "@/assets/Paisajismo/Pallet-jardinera-quilicura-reciclaje-3.jpg";
import img4 from "@/assets/Paisajismo/Pallet-jardinera-quilicura-reciclaje-4.jpg";

export const Route = createFileRoute("/Paisajismo-jardinera-pallet-mall-quilicura")({
  head: () => ({
    meta: [
      { title: "Jardinera Pallet Mall Quilicura | Bascharant" },
      { name: "description", content: "Proyecto de jardinera con pallet reciclado y plantas de temporada en Quilicura." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Jardinera Pallet Mall Quilicura</h1>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Jardinera Pallet Mall Quilicura - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Proyecto que destaca por el uso de materiales reciclados. Se utilizó un pallet reciclado transformado en una jardinera funcional, decorada con plantas de temporada, para embellecer los espacios exteriores del Mall Arauco Quilicura. Este tipo de soluciones promueve la sostenibilidad y el <strong>diseño ecológico</strong> en áreas de alto tránsito.
              </p>
            </div>
          </div>
