...
export const Route = createFileRoute("/Paisajismo-jardinera-pallet-mall-quilicura")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Proyecto de jardinera con pallet reciclado y plantas de temporada en Quilicura.",
      },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            Jardinera Pallet Mall Quilicura
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Proyecto que destaca por el uso de materiales reciclados. Se utilizó un pallet
                reciclado transformado en una jardinera funcional, decorada con plantas de
                temporada, para embellecer los espacios exteriores del Mall Arauco Quilicura. Este
                tipo de soluciones promueve la sostenibilidad y el <strong>diseño ecológico</strong>{" "}
