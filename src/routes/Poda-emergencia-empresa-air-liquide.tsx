...
import img1 from "@/assets/Trabajos/Poda-emergencia-air -liquide-noviembre-2017.jpg";
import img2 from "@/assets/Trabajos/Poda-emergencia-air -liquide-noviembre-2017-2.jpg";
import img3 from "@/assets/Trabajos/Poda-emergencia-air -liquide-noviembre-2017-3.jpg";
import img4 from "@/assets/Trabajos/Poda-emergencia-air -liquide-noviembre-2017-4.jpg";

export const Route = createFileRoute("/Poda-emergencia-empresa-air-liquide")({
  head: () => ({
    meta: [
      { title: "Poda Emergencia Air Liquide | Bascharant" },
      { name: "description", content: "Poda emergencia empresa air-liquide retiro de ramas." },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-destructive">Poda Emergencia Empresa Air Liquide</h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Poda Emergencia Air Liquide - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Operativo de <strong>ejecución de obras</strong> correspondiente a poda de emergencia y retiro de ramas en las instalaciones de la empresa Air Liquide Chile S.A. ubicadas en Quilicura. Se ejecutaron las labores en un plazo de 2 días para solucionar la emergencia de manera segura y eficiente.
              </p>
            </div>
          </div>
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    ...
                    <span className="text-destructive font-bold">2 días</span>
                  </span>
                </li>
              </ul>
