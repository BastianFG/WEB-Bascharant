          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Operativo de <strong>ejecución de obras</strong> correspondiente a poda de
                emergencia y retiro de ramas en las instalaciones de la empresa Air Liquide Chile
                S.A. ubicadas en Quilicura. Se ejecutaron las labores en un plazo de 2 días para
                solucionar la emergencia de manera segura y eficiente.
              </p>
            </div>
          </div>
