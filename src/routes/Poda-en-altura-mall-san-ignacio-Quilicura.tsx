...
export const Route = createFileRoute("/Poda-en-altura-mall-san-ignacio-Quilicura")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Poda en altura ejecutada en el Mall Arauco San Ignacio Quilicura.",
      },
    ],
  }),
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">
              Poda en Altura Mall San Ignacio Quilicura
            </h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Operativo de <strong>ejecución de obras</strong> correspondiente a la poda en altura
                en las instalaciones del Mall Arauco San Ignacio, ubicado en Quilicura. Las labores
                se llevaron a cabo de forma segura y eficiente durante un plazo de 3 días para
                garantizar la mantención del arbolado urbano y la seguridad de los visitantes del
                recinto.
              </p>
            </div>
          </div>
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[var(--olive)] mt-1 flex-shrink-0" />3
                    días
                  </span>
                </li>
              </ul>
              ...
              <div className="mt-10 pt-8 border-t border-border/50 text-center">
                <p className="text-sm text-muted-foreground mb-4">
                  ¿Necesitas poda en altura u otros servicios?
                </p>
                <a
                  href="/#contacto"
