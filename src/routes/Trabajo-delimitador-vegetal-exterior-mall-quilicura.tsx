  ...
  head: () => ({
    meta: [
      { title: "Delimitador Vegetal Exterior Mall Quilicura | Bascharant" },
      {
        name: "description",
        content:
          "Ejecución de delimitador vegetal con plantas Pittosporum tobira en el exterior del Mall Quilicura.",
      },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            Delimitador Vegetal Exterior Mall Quilicura
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Trabajo de <strong>ejecución de obras</strong> consistente en la creación de un
                delimitador vegetal utilizando plantas de la especie <em>Pittosporum tobira</em> en
                los exteriores del Mall Arauco Quilicura. Este cerco vivo ayuda a zonificar los
                espacios de manera natural y estética, garantizando además durabilidad gracias a la
                resistencia de esta especie en zonas de alto tránsito.
              </p>
            </div>
          </div>
