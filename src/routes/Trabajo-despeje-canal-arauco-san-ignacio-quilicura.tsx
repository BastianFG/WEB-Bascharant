  ...
  head: () => ({
    meta: [
      { title: "Despeje Preventivo de Canal Arauco San Ignacio | Bascharant" },
      {
        name: "description",
        content:
          "Ejecución de obras de despeje preventivo de canal tras lluvias en Arauco San Ignacio Quilicura.",
      },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            Despeje Preventivo de Canal Arauco San Ignacio Quilicura
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Operativo de <strong>ejecución de obras</strong> enfocado en el despeje preventivo
                del canal perimetral en Arauco San Ignacio Quilicura, ejecutado como medida
                correctiva y preventiva tras fuertes eventos de lluvias. Este trabajo garantizó la
                correcta canalización y flujo de aguas pluviales, removiendo sedimentos, material
                vegetal y obstrucciones que pudieran generar anegamientos en las instalaciones.
              </p>
            </div>
          </div>
