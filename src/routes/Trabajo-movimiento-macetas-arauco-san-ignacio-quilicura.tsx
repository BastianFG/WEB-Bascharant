...
import img1 from "@/assets/Trabajos/Movimiento-macetas-arauco-san-ignacio-quilicura-1.jpg";
import img2 from "@/assets/Trabajos/Movimiento-macetas-arauco-san-ignacio-quilicura-2.jpg";
import img3 from "@/assets/Trabajos/Movimiento-macetas-arauco-san-ignacio-quilicura-3.jpg";

export const Route = createFileRoute("/Trabajo-movimiento-macetas-arauco-san-ignacio-quilicura")({
  head: () => ({
    meta: [
      { title: "Movimiento Macetas Arauco San Ignacio Quilicura | Bascharant" },
      { name: "description", content: "Ejecución de movimiento de macetas en Mall Arauco San Ignacio Quilicura." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Movimiento Macetas Arauco San Ignacio Quilicura</h1>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Movimiento Macetas - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Trabajo de <strong>ejecución de obras</strong> consistente en el movimiento y reubicación de macetas en el Mall Arauco San Ignacio Quilicura. Este procedimiento se llevó a cabo garantizando la integridad de las especies vegetales y respetando los tiempos de operación del recinto para no interrumpir el flujo del centro comercial.
              </p>
            </div>
          </div>
