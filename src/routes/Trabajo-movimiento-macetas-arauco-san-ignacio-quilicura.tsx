...
export const Route = createFileRoute("/Trabajo-movimiento-macetas-arauco-san-ignacio-quilicura")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Ejecución de movimiento de macetas en Mall Arauco San Ignacio Quilicura.",
      },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            Movimiento Macetas Arauco San Ignacio Quilicura
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Trabajo de <strong>ejecución de obras</strong> consistente en el movimiento y
                reubicación de macetas en el Mall Arauco San Ignacio Quilicura. Este procedimiento
                se llevó a cabo garantizando la integridad de las especies vegetales y respetando
                los tiempos de operación del recinto para no interrumpir el flujo del centro
                comercial.
              </p>
            </div>
          </div>
