...
export const Route = createFileRoute("/Trabajo-movimiento-macetas-quilicura")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Proyecto de movimiento y reubicación de macetas en Quilicura para Arauco.",
      },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            Movimiento de Macetas en Quilicura
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Trabajo de ejecución consistente en el movimiento y reubicación de macetas de gran
                volumen en Quilicura para el mandante Arauco Quilicura. Este proyecto requirió de
                logística y precisión para asegurar la integridad de las especies vegetales y el
                correcto emplazamiento según los requerimientos del cliente.
              </p>
            </div>
          </div>
