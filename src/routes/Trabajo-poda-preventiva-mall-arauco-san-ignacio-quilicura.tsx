...
import img1 from "@/assets/Trabajos/Poda-Preventiva-Mall-Arauco-san-ignacio-Quilicura-1.jpg";
import img2 from "@/assets/Trabajos/Poda-Preventiva-Mall-Arauco-san-ignacio-Quilicura-2.jpg";
import img3 from "@/assets/Trabajos/Poda-Preventiva-Mall-Arauco-san-ignacio-Quilicura-3.jpg";
import img4 from "@/assets/Trabajos/Poda-Preventiva-Mall-Arauco-san-ignacio-Quilicura-4.jpg";

export const Route = createFileRoute("/Trabajo-poda-preventiva-mall-arauco-san-ignacio-quilicura")({
  head: () => ({
    meta: [
      { title: "Poda Preventiva Mall Arauco San Ignacio Quilicura | Bascharant" },
      { name: "description", content: "Ejecución de poda preventiva utilizando podadoras en altura y motosierras, con retiro de ramas en Quilicura." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Poda Preventiva Mall Arauco San Ignacio Quilicura</h1>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Poda Preventiva - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Servicio especializado de <strong>poda preventiva</strong> realizado en las inmediaciones del Mall Arauco San Ignacio en Quilicura. Durante la ejecución se utilizaron podadoras en altura y motosierras para garantizar un corte seguro y efectivo, mitigando riesgos de desprendimiento y mejorando la salud y estructura de los ejemplares arbóreos. Adicionalmente, el servicio incluyó la recolección y retiro total de ramas y residuos vegetales.
              </p>
            </div>
          </div>
