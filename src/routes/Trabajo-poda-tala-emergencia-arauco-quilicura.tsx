...
import { ArrowLeft, CheckCircle2, ChevronLeft, ChevronRight, AlertTriangle } from "lucide-react";
import { useState } from "react";
import img1 from "@/assets/Trabajos/poda-tala-emergencia-arauco-quilicura-1.jpg";
import img2 from "@/assets/Trabajos/poda-tala-emergencia-arauco-quilicura-2.jpg";
import img3 from "@/assets/Trabajos/poda-tala-emergencia-arauco-quilicura-3.jpg";
import img4 from "@/assets/Trabajos/poda-tala-emergencia-arauco-quilicura-4.jpg";

export const Route = createFileRoute("/Trabajo-poda-tala-emergencia-arauco-quilicura")({
  head: () => ({
    meta: [
      { title: "Poda y Tala de Emergencia Arauco Quilicura | Bascharant" },
      { name: "description", content: "Ejecución de obras de poda y tala de emergencia en Arauco Quilicura." },
    ],
  }),
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-destructive">Poda y Tala de Emergencia Arauco Quilicura</h1>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="relative rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10 group">
              <img 
                ...
                alt={`Poda y Tala Emergencia - Imagen ${currentIndex + 1}`} 
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                Operativo de <strong>ejecución de obras</strong> de carácter urgente consistente en la poda y tala de emergencia de ejemplares arbóreos en el recinto de Arauco Quilicura. Este servicio requirió un despliegue rápido y seguro para eliminar riesgos inminentes de caídas, asegurando así la integridad de las instalaciones y de las personas.
              </p>
            </div>
          </div>
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    ...
                    <span className="text-destructive font-bold">1 día (Emergencia)</span>
                  </span>
                </li>
              </ul>
              
              <div className="mt-10 pt-8 border-t border-border/50 text-center">
                <p className="text-sm text-muted-foreground mb-4">¿Necesitas asistencia de emergencia?</p>
                <a 
                  href="/#contacto"
                  className="inline-flex w-full justify-center items-center rounded-full bg-destructive px-6 py-3.5 text-sm font-semibold tracking-wide text-destructive-foreground hover:bg-destructive/90 transition-all shadow-md hover:shadow-lg"
                >
                  Contactar Urgencia
                </a>
              </div>
