  ...
  head: () => ({
    meta: [
      ...
      { title: "Paisajismo Bascharant | Paisajismo Corporativo y Sustentable en Chile" },
      {
        name: "description",
        content:
          "Diseño, construcción y mantención de áreas verdes corporativas, industriales e institucionales en Chile. Más de 10 años de experiencia.",
      },
      ...
      },
      {
        ...
        content:
          "Servicios integrales de paisajismo a gran escala para constructoras, inmobiliarias e industrias en Chile.",
      },
