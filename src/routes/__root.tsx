...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Diseño, construcción y mantención de áreas verdes corporativas, industriales e institucionales en Chile. Más de 10 años de experiencia." },
      ...
      { property: "og:description", content: "Servicios integrales de paisajismo a gran escala para constructoras, inmobiliarias e industrias en Chile." },
