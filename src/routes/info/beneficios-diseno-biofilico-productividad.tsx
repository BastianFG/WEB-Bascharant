  ...
  head: () => ({
    meta: [
      { title: "Beneficios del Diseño Biofílico | Info" },
      {
        name: "description",
        content:
          "Aprende cómo la integración de áreas verdes y el diseño biofílico en empresas corporativas reduce el estrés, mejora la salud mental y eleva la productividad.",
      },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden min-h-screen flex flex-col">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-border/40">
        ...
        <div className="relative mx-auto max-w-4xl px-6 lg:px-10 z-10">
          ...
          >
            Beneficios del <span className="italic text-[var(--olive)]">Diseño Biofílico</span> en
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 article-content">
          <div className="prose prose-lg dark:prose-invert prose-headings:font-display prose-headings:font-normal prose-a:text-[var(--olive)] prose-a:no-underline hover:prose-a:underline max-w-none">
            <p className="lead text-xl text-muted-foreground mb-10">
              Las oficinas estériles y grises son cosa del pasado. Hoy en día, la incorporación
              estratégica de la naturaleza en los espacios de trabajo, conocida como{" "}
              <strong>
                <GlossaryLink>Diseño Biofílico</GlossaryLink>
              </strong>
              , se ha convertido en una herramienta comprobada para potenciar la retención de
            ...
            <p>
              El término{" "}
              <em>
                <GlossaryLink>biofilia</GlossaryLink>
              </em>{" "}
              significa literalmente "amor a la vida". En arquitectura y paisajismo, se refiere a la
              necesidad humana innata de estar en contacto con la naturaleza. Un diseño biofílico va
              más allá de poner una maceta en un escritorio; implica una integración profunda de luz
              natural, agua, vegetación y materiales orgánicos en la estructura de la empresa.
            </p>
            ...
            <div className="my-12 p-8 rounded-2xl bg-[var(--olive)]/5 border border-[var(--olive)]/20">
              ...
              <p className="text-muted-foreground text-base m-0">
                Diversos estudios globales (como el informe Human Spaces) indican que los
                trabajadores en entornos con elementos naturales reportan niveles de bienestar un{" "}
                <strong>15% más altos</strong> y son hasta un <strong>6% más productivos</strong>.
                La exposición a plantas ayuda a reponer la fatiga cognitiva, mejorando la
                concentración.
              </p>
            </div>
            ...
            <p>
              La mala ventilación, la iluminación artificial constante y los compuestos orgánicos
              volátiles (COV) de muebles y alfombras causan fatiga, dolores de cabeza e irritación,
              contribuyendo al ausentismo laboral. Un diseño de paisajismo interior mitiga esto:
            </p>
            <ul>
              <li>
                <strong>Filtros vivos:</strong> Las plantas absorben dióxido de carbono y toxinas
                del aire, liberando oxígeno fresco.
              </li>
              <li>
                <strong>Confort acústico:</strong> Las hojas y el sustrato de jardines interiores o
                muros verdes actúan como paneles fonoabsorbentes, disminuyendo el eco en oficinas
                abiertas ("open space").
              </li>
            </ul>
            ...
            <p>
              Para las nuevas generaciones que se integran a la fuerza laboral, un entorno que
              refleje preocupación por el medio ambiente y la salud de las personas no es un lujo,
              es una exigencia. Un paisajismo corporativo vibrante y bien mantenido proyecta una
              cultura de bienestar, reduciendo significativamente los índices de rotación.
            </p>
            ...
            <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                ...
                <p className="text-muted-foreground text-sm">
                  Nuestro equipo de paisajistas diseña y mantiene áreas verdes corporativas.
                </p>
              </div>
              <a
                href="/contacto"
