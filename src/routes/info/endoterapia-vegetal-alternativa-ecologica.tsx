  ...
  head: () => ({
    meta: [
      { title: "Endoterapia Vegetal | Info" },
      {
        name: "description",
        content:
          "Conoce la Endoterapia Vegetal, una alternativa ecológica y segura para el control fitosanitario del arbolado en entornos corporativos y urbanos.",
      },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden min-h-screen flex flex-col">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-border/40">
        ...
        <div className="relative mx-auto max-w-4xl px-6 lg:px-10 z-10">
          ...
          >
            <span className="italic text-[var(--olive)]">Endoterapia Vegetal:</span> Alternativa
            Ecológica para Empresas
          </motion.h1>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 article-content">
          <div className="prose prose-lg dark:prose-invert prose-headings:font-display prose-headings:font-normal prose-a:text-[var(--olive)] prose-a:no-underline hover:prose-a:underline max-w-none">
            <p className="lead text-xl text-muted-foreground mb-10">
              Durante décadas, el control de plagas en árboles de gran altura ha dependido de
              fumigaciones aéreas y aspersiones. Este método no solo desperdicia gran cantidad de
              químicos, sino que es altamente tóxico para los transeúntes, empleados y fauna útil
              (como abejas). La{" "}
              <strong>
                <GlossaryLink>Endoterapia</GlossaryLink>
              </strong>{" "}
            ...
            <div className="my-12 p-8 rounded-2xl bg-[var(--olive)]/5 border border-[var(--olive)]/20">
              ...
              <p className="text-muted-foreground text-base m-0">
                Al igual que una "vacuna", la <GlossaryLink>endoterapia vegetal</GlossaryLink>{" "}
                consiste en la inyección directa del producto fitosanitario (o nutriente) en el
                sistema vascular del árbol. La propia savia de la planta se encarga de distribuir el
                producto de manera uniforme hasta las hojas, eliminando la plaga desde adentro.
              </p>
            </div>
            ...
            <ul>
              <li>
                <strong>Cero contaminación ambiental:</strong> Al no haber aspersión, no hay deriva
                por viento. El químico jamás entra en contacto con el aire, el suelo, ni el agua
                subterránea.
              </li>
              <li>
                <strong>Inocuidad para personas:</strong> Se puede aplicar en pleno horario laboral
                o en zonas de alto tránsito peatonal sin necesidad de evacuar ni acordonar el área.
              </li>
              <li>
                <strong>Efectividad prolongada:</strong> El producto queda encapsulado dentro del
                árbol, protegiéndolo hasta por un año entero, lo que reduce la frecuencia de
                intervenciones de mantenimiento.
              </li>
              <li>
                <strong>Protección de Biodiversidad:</strong> Como solo afecta a los insectos que se
                alimentan de la savia o las hojas del árbol (plagas), los insectos polinizadores y
                depredadores naturales no sufren daños.
              </li>
            </ul>

            <h2 className="text-3xl mt-12 mb-6">El Estándar Moderno</h2>
            <p>
              Cualquier empresa que busque certificaciones ambientales o de sustentabilidad (como
              LEED o ISO 14001) debe considerar fuertemente el reemplazo de fumigaciones
              tradicionales por Endoterapia para el cuidado de su arbolado.
            </p>
            ...
            <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                ...
                <p className="text-muted-foreground text-sm">
                  Ofrecemos servicios de Endoterapia y Control Fitosanitario.
                </p>
              </div>
              <a
