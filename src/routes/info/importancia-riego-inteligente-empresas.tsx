  ...
  head: () => ({
    meta: [
      { title: "Sistemas de Riego Inteligente | Info" },
      {
        name: "description",
        content:
          "La importancia de implementar sistemas de riego tecnificado e inteligente en áreas corporativas para optimizar el consumo de agua y reducir costos.",
      },
    ],
  }),
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-border/40">
        ...
        <div className="relative mx-auto max-w-4xl px-6 lg:px-10 z-10">
          ...
          >
            ...
            <span className="italic text-[var(--clay)]">Sistemas de Riego Inteligente</span>
          </motion.h1>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 article-content">
          <div className="prose prose-lg dark:prose-invert prose-headings:font-display prose-headings:font-normal prose-a:text-[var(--clay)] prose-a:no-underline hover:prose-a:underline max-w-none">
            <p className="lead text-xl text-muted-foreground mb-10">
              Un error común en las grandes infraestructuras empresariales es mantener un sistema de
              riego anticuado (con mangueras o aspersores mal calibrados) basándose en que "aún
              funciona". Esta ineficiencia se traduce en pérdidas millonarias anuales debido al
              desperdicio de agua y daño estructural.
            </p>

            <h2 className="text-3xl mt-12 mb-6">El Problema del Riego Tradicional</h2>
            <p>
              El riego manual o con programadores obsoletos no toma en cuenta las variables
              ambientales. Riega durante lluvias, evapora el agua si riega en horas de calor máximo,
              y a menudo genera encharcamientos que pudren las raíces y propician enfermedades
              fungosas (hongos).
            </p>
            ...
            <div className="my-12 p-8 rounded-2xl bg-[var(--clay)]/5 border border-[var(--clay)]/20">
              ...
              <h3 className="text-xl font-medium mb-3 mt-0 text-foreground">
                El Riego Tecnificado e Inteligente
              </h3>
              <p className="text-muted-foreground text-base m-0">
                Un sistema de <GlossaryLink>riego inteligente</GlossaryLink> incluye{" "}
                <strong>sensores de lluvia y humedad de suelo</strong>. Además, los programadores
                modernos se conectan a internet para leer el pronóstico del clima local, ajustando
                automáticamente los tiempos de riego según la evapotranspiración diaria real.
              </p>
            </div>

            <h2 className="text-3xl mt-12 mb-6">Riego por Goteo: Precisión Quirúrgica</h2>
            <p>
              Especialmente en proyectos de Xerojardinería y macizos florales, el cambio de
              aspersores a <strong>líneas de goteo</strong> es fundamental. El agua se entrega
              directamente a la zona radicular (las raíces) de forma lenta, eliminando la
              evaporación por viento y minimizando el crecimiento de malezas, ya que el suelo
              superficial permanece seco.
            </p>

            <h2 className="text-3xl mt-12 mb-6">Retorno de Inversión (ROI)</h2>
            <p>
              Aunque la instalación de un sistema automatizado requiere una inversión inicial, el
              retorno es sorprendentemente rápido. La disminución de hasta un 50% en la cuenta de
              agua potable (o industrial) y la fuerte reducción en las horas-hombre dedicadas al
              riego manual amortizan el proyecto generalmente en los primeros 12 a 18 meses.
            </p>
            ...
            <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                ...
                <p className="text-muted-foreground text-sm">
                  Evaluamos y reparamos la red hídrica de tu corporación.
                </p>
              </div>
              <a
