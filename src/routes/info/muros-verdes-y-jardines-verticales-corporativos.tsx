  ...
  head: () => ({
    meta: [
      { title: "Muros Verdes y Jardines Verticales | Info" },
      {
        name: "description",
        content:
          "Descubre cómo los muros verdes combaten las islas de calor urbanas, mejoran la calidad del aire y elevan la estética arquitectónica de tu empresa.",
      },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden min-h-screen flex flex-col">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-border/40">
        ...
        <div className="relative mx-auto max-w-4xl px-6 lg:px-10 z-10">
          ...
          >
            Muros Verdes: Combatiendo{" "}
            <span className="italic text-[var(--sage)]">Islas de Calor</span> y Mejorando la Imagen
          </motion.h1>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 article-content">
          <div className="prose prose-lg dark:prose-invert prose-headings:font-display prose-headings:font-normal prose-a:text-[var(--sage)] prose-a:no-underline hover:prose-a:underline max-w-none">
            <p className="lead text-xl text-muted-foreground mb-10">
              En zonas densamente pobladas y parques industriales, el espacio horizontal es un
              recurso escaso. Las fachadas de edificios, muros ciegos y columnas representan
              "lienzos" perfectos para implementar{" "}
              <strong>
                <GlossaryLink>jardines verticales</GlossaryLink>
              </strong>{" "}
              que no solo decoran, sino que cumplen un rol ecológico vital.
            </p>
            ...
            <div className="my-12 p-8 rounded-2xl bg-[var(--sage)]/10 border border-[var(--sage)]/20">
              ...
              <p className="text-muted-foreground text-base m-0">
                Las superficies de concreto y asfalto absorben la radiación solar y la re-emiten
                como calor, elevando artificialmente la temperatura de la ciudad. Un{" "}
                <GlossaryLink>muro verde</GlossaryLink> actúa como un{" "}
                <strong>aislante térmico</strong>. Refleja la radiación solar, reduce la temperatura
                de la pared exterior (y por ende el uso de aire acondicionado interior) y refresca
                el aire mediante la evapotranspiración de las hojas.
              </p>
            </div>
            ...
            <ul>
              <li>
                <strong>Optimización de Espacio:</strong> Permite tener un jardín exuberante sin
                restar metros cuadrados útiles al estacionamiento o áreas comunes.
              </li>
              <li>
                <strong>Purificación del Aire:</strong> Las plantas capturan el material particulado
                (smog, polvo) y absorben dióxido de carbono.
              </li>
              <li>
                <strong>Aislamiento Acústico:</strong> La masa vegetal amortigua el ruido de la
                calle, creando un interior mucho más silencioso.
              </li>
              <li>
                <strong>Estética Monumental:</strong> Una fachada verde cubierta de vida posiciona
                visualmente el edificio como un hito sustentable e innovador.
              </li>
            </ul>

            <h2 className="text-3xl mt-12 mb-6">Mantenimiento y Riego</h2>
            <p>
              Construir un muro verde requiere pericia técnica. Utilizamos sistemas hidropónicos o
              de sustrato especializado con riego por goteo automatizado y canaletas de
              recirculación de agua para garantizar que la estructura no sufra filtraciones de
              humedad y la vegetación se mantenga próspera con bajo consumo hídrico.
            </p>
            ...
            <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                ...
                <p className="text-muted-foreground text-sm">
                  Explora nuestros proyectos de habilitación vertical.
                </p>
              </div>
              <a
