  ...
  head: () => ({
    meta: [
      { title: "Xerojardinería y Paisajismo Seco | Info" },
      {
        name: "description",
        content:
          "Soluciones de paisajismo sustentable ante la crisis hídrica. Conoce las ventajas corporativas de la xerojardinería y la eficiencia hídrica.",
      },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden min-h-screen flex flex-col">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 border-b border-border/40">
        ...
        <div className="relative mx-auto max-w-4xl px-6 lg:px-10 z-10">
          ...
          >
            <span className="italic text-muted-foreground">Xerojardinería:</span> La Solución
            Sustentable ante la Crisis Hídrica
          </motion.h1>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10 article-content">
          <div className="prose prose-lg dark:prose-invert prose-headings:font-display prose-headings:font-normal prose-a:text-[var(--charcoal)] prose-a:no-underline hover:prose-a:underline max-w-none">
            <p className="lead text-xl text-muted-foreground mb-10">
              Con el cambio climático y la sequía prolongada en la zona central, mantener vastas
              extensiones de césped en corporaciones es insostenible financiera y ecológicamente. La
              respuesta es la{" "}
              <strong>
                <GlossaryLink>Xerojardinería</GlossaryLink>
              </strong>{" "}
              (o Paisajismo Seco).
            </p>
            ...
            <p>
              El modelo tradicional de paisajismo comercial priorizaba grandes explanadas de pasto
              que consumen cientos de litros de agua diarios, además de requerir cortadoras (que
              consumen combustible y emiten ruido) y altos niveles de fertilizantes. Las empresas
              modernas están haciendo una transición rápida hacia el reemplazo de estos paños de
              pasto por alternativas de bajo consumo.
            </p>
            ...
            <div className="my-12 p-8 rounded-2xl bg-[var(--charcoal)]/5 border border-[var(--charcoal)]/20">
              ...
              <h3 className="text-xl font-medium mb-3 mt-0 text-foreground">
                El Estrés Hídrico en Chile
              </h3>
              <p className="text-muted-foreground text-base m-0">
                Al adoptar especies nativas y flora adaptada, una empresa puede reducir su huella
                hídrica (consumo de agua para riego) <strong>hasta en un 70%</strong>. Esto no solo
                genera un impacto ecológico tremendo, sino que amortigua directamente la factura
            ...
            <ul>
              <li>
                <strong>Selección Vegetal Nativa:</strong> Especies xerófitas o de clima
                mediterráneo (como el pennisetum, romero rastrero, lavandas y suculentas) que están
                biológicamente preparadas para soportar largos períodos de sequía.
              </li>
              <li>
                <strong>Uso de Mulch y Cubresuelos:</strong> Aplicar cortezas de árbol, gravillas o
                canto rodado sobre el sustrato frena la evaporación del agua, manteniendo la humedad
                del suelo y dificultando el crecimiento de malezas.
              </li>
              <li>
                <strong>Topografía Funcional:</strong> Diseño de leves desniveles ("Rain Gardens")
                que captan el agua lluvia invernal y permiten que percole hacia las napas, evitando
                la <GlossaryLink>escorrentía</GlossaryLink> inútil.
              </li>
            </ul>

            <h2 className="text-3xl mt-12 mb-6">Imagen Corporativa de Responsabilidad</h2>
            <p>
              Cambiar un jardín tradicional por xerojardinería manda un mensaje potente a la
              comunidad y a los inversionistas (ESG): la corporación es consciente de su entorno,
              asume el desafío del cambio climático y toma acciones concretas de conservación de
              recursos.
            </p>
            ...
            <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="text-center sm:text-left">
                <h4 className="font-medium text-lg mb-1">
                  ¿Listo para reconvertir tus áreas verdes?
                </h4>
                <p className="text-muted-foreground text-sm">
                  Realizamos proyectos de reconversión hídrica "llave en mano".
                </p>
              </div>
              <a
