...
import img from "@/assets/Paisajismo/g4.jpg";

export const Route = createFileRoute("/proyecto-diseno-paisajismo-vial-copec-santiago-chile")({
  head: () => ({
    meta: [
      { title: "Diseño de Paisajismo Vial y Acceso Santiago Chile | Bascharant" },
      { name: "description", content: "Diseño de paisajismo vial y acceso corporativo en Santiago. Soluciones en diseño 3D y especificaciones técnicas para áreas verdes en Chile." },
      { name: "keywords", content: "diseño paisajismo vial, paisajismo santiago chile, mantencion areas verdes, modelado 3d paisajismo" },
      { property: "og:title", content: "Diseño de Paisajismo Vial y Acceso Santiago Chile | Bascharant" },
      { property: "og:description", content: "Diseño de paisajismo vial y acceso corporativo en Santiago. Soluciones en diseño 3D y especificaciones técnicas para áreas verdes en Chile." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">{ "Plano Acceso y Paisajismo Vial en Santiago" }</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            <div className="rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10">
              <img 
                src={img} 
                alt="Plano Acceso y Paisajismo Vial en Santiago" 
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    { "Diseño paisajístico 3D y especificaciones técnicas" }
                  </span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-primary">{ "25 días" }</span>
                  </span>
                </li>
              </ul>
