...
export const Route = createFileRoute("/proyecto-diseno-paisajismo-vial-copec-santiago-chile")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Diseño de Paisajismo Vial y Acceso Santiago Chile | Bascharant",
      },
      {
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {"Plano Acceso y Paisajismo Vial en Santiago"}
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p
                className="text-muted-foreground leading-relaxed text-[17px]"
