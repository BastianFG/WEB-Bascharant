  ...
  head: () => ({
    meta: [
      { title: "Fumigación y Control Fitosanitario Áreas Verdes Quilicura | Bascharant" },
      {
        name: "description",
        content:
          "Servicio de fumigación y control fitosanitario para grandes superficies  en Quilicura. Expertos en salud vegetal en Chile.",
      },
      {
        name: "keywords",
        content:
      ...
      {
        property: "og:title",
        content: "Fumigación y Control Fitosanitario Áreas Verdes Quilicura | Bascharant",
      },
      {
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {"Fumigación y Control Fitosanitario en Quilicura"}
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            <div className="rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10">
              <img
                src={img}
                alt="Fumigación y Control Fitosanitario en Quilicura"
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                La protección de grandes extensiones vegetales requiere un manejo técnico experto.
                Nuestro servicio mensual de{" "}
                <strong>
                  fumigación y control <GlossaryLink>fitosanitario</GlossaryLink>
                </strong>{" "}
                en Quilicura abarca 8.500 m², asegurando la prevención de plagas en áreas comunes.
                Complementamos la <strong>mantención de áreas verdes en Chile</strong> con un
                enfoque científico y productos amigables con el medio ambiente.
              </p>
            </div>
          </div>
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    {"Prevención fitosanitaria en áreas comunes"}
                  </span>
                </li>
                <li>
                  <span className="block text-sm font-medium text-muted-foreground mb-1">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    <span className="text-primary">{"Servicio Mensual"}</span>
                  </span>
                </li>
              </ul>
