  ...
  head: () => ({
    meta: [
      { title: "Mantención Áreas Verdes  San Ignacio Chile | Bascharant" },
      {
        name: "description",
        content:
          "Contrato de mantención de áreas verdes  y poda en altura en San Ignacio. Empresa líder en paisajismo en Chile.",
      },
      {
        name: "keywords",
        content:
          "mantencion areas verdes , poda en altura chile, paisajismo industrial, jardineria san ignacio",
      },
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {"Mantención de Áreas Verdes en San Ignacio"}
          </h1>
        </div>
