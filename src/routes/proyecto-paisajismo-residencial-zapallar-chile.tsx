...
export const Route = createFileRoute("/proyecto-paisajismo-residencial-zapallar-chile")({
  head: () => ({
    meta: [
      { title: "Paisajismo Residencial Zapallar Chile | Instalación y Riego" },
      { name: "description", content: "Proyecto de paisajismo residencial en Zapallar. Especialistas en instalación de pasto alfombra, riego automatizado y mantención de áreas verdes." },
      { name: "keywords", content: "paisajismo residencial zapallar, instalacion pasto alfombra, sistema de riego chile, mantencion areas verdes" },
      { property: "og:title", content: "Paisajismo Residencial Zapallar Chile | Instalación y Riego" },
      { property: "og:description", content: "Proyecto de paisajismo residencial en Zapallar. Especialistas en instalación de pasto alfombra, riego automatizado y mantención de áreas verdes." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">{ "Paisajismo Residencial Exclusivo en Zapallar" }</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            <div className="rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10">
              <img 
                src={img} 
                alt="Paisajismo Residencial Exclusivo en Zapallar" 
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    { "Instalación Pasto alfombra, sistema de riego" }
                  </span>
                </li>
                <li>
