...
export const Route = createFileRoute(
  ...
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Proyecto Paisajismo Seco y Reconversión Hídrica Chile | Bascharant",
      },
      {
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {"Paisajismo Seco y Reconversión Hídrica en Quilicura"}
          </h1>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                En este proyecto ejecutado en Quilicura, aplicamos los más altos estándares de{" "}
                <strong>
                  <GlossaryLink>paisajismo seco</GlossaryLink> y reconversión hídrica
                </strong>{" "}
                para optimizar el consumo de agua. Como especialistas en{" "}
                <strong>mantención de áreas verdes en Chile</strong>, reemplazamos el césped
                tradicional por especies de bajo requerimiento hídrico e instalamos un sistema de{" "}
                <strong>riego automatizado</strong> altamente eficiente, garantizando la
                sustentabilidad a largo plazo de las instalaciones Arauco.
              </p>
            </div>
          </div>
