...
export const Route = createFileRoute("/proyecto-poda-preventiva-silvicultura-arbolado-quilicura-chile")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Servicios de poda certificada, silvicultura y control fitosanitario de arbolado en Quilicura. Expertos en mantención de áreas verdes en Chile." },
      { name: "keywords", content: "poda preventiva chile, silvicultura urbana, control fitosanitario, mantencion areas verdes quilicura, poda certificada" },
      { property: "og:title", content: "Poda Preventiva y Silvicultura Quilicura Chile | Bascharant" },
      { property: "og:description", content: "Servicios de poda certificada, silvicultura y control fitosanitario de arbolado en Quilicura. Expertos en mantención de áreas verdes en Chile." },
    ],
  }),
    ...
    <main className="relative bg-background text-foreground antialiased overflow-x-hidden pt-24">
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">{ "Poda Preventiva y Silvicultura en Quilicura" }</h1>
        </div>
