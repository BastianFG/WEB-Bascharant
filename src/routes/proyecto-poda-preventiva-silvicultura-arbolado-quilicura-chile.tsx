...
export const Route = createFileRoute(
  ...
  head: () => ({
    meta: [
      { title: "Poda Preventiva y Silvicultura Quilicura Chile | Bascharant" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "Poda Preventiva y Silvicultura Quilicura Chile | Bascharant",
      },
      {
      ...
      <article className="container mx-auto px-6 py-12 md:py-20 max-w-6xl">
        <div className="mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            {"Poda Preventiva y Silvicultura en Quilicura"}
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            <div className="rounded-3xl overflow-hidden bg-muted border border-border/50 shadow-lg mb-10">
              <img
                src={img}
                alt="Poda Preventiva y Silvicultura en Quilicura"
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed text-[17px]">
                La{" "}
                <strong>
                  <GlossaryLink>silvicultura</GlossaryLink> y poda preventiva
                </strong>{" "}
                son esenciales para la seguridad industrial. En este proyecto en Quilicura, nuestros
                expertos en <strong>mantención de áreas verdes en Chile</strong> realizaron podas
                certificadas y tratamientos de{" "}
                <strong>
                  control <GlossaryLink>fitosanitario</GlossaryLink>
                </strong>{" "}
                en 45 ejemplares. Aseguramos la salud del arbolado y mitigamos riesgos,
                consolidándonos como líderes en paisajismo y manejo arbóreo.
              </p>
            </div>
          </div>
            ...
            <div className="sticky top-32 p-8 rounded-3xl bg-secondary/30 border border-border/60 shadow-[0_10px_40px_-10px_rgba(132,175,76,0.1)]">
              ...
              <ul className="space-y-6">
                ...
                <li>
                  ...
                  <span className="block text-foreground font-semibold flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                    {"Poda certificada y control fitosanitario"}
                  </span>
                </li>
                <li>
                  <span className="block text-sm font-medium text-muted-foreground mb-1">
